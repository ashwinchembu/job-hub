...
const guidewireScreeningPrep: CompanyScreeningPrep = {
  ...
  interviewProcess: "Confirmed inbound recruiter contact: Annie from Guidewire left a voicemail on August 14, 2026 at 4:24 PM regarding a Software Engineer II role on a product-development team after Arun Prasad forwarded Ashwin’s resume. Expected sequence from the referral note: recruiter screen with Annie Palathingal → online coding challenge → hiring-manager conversation with Travis McKlesky. The original referral described a Junior Full-Stack AI Engineer role while the voicemail said Software Engineer II; confirm whether these are the same requisition and ask for the official job description, requisition ID, team, level, location expectations, and interview sequence.",
  ...
  checklist: "Return Annie’s voicemail at (650) 436-4113\nConfirm whether Software Engineer II is the same requisition as Junior Full-Stack AI Engineer\nRequest the official job description, requisition ID, team, and location expectations\nMemorize the one-sentence company explanation\nPractice the 60-second recruiter pitch out loud twice\nGive the why-Guidewire answer without generic praise\nRehearse Lume, ZS AI, job automation, and Sylk stories\nConfirm coding-challenge platform, language options, format, and timeline\nConfirm compensation range since the referral post did not list one\nReview the brief before the Travis McKlesky round",
};

const featuredApplications: Application[] = [{
  id: "featured-guidewire-junior-full-stack-ai-engineer",
  company: "Guidewire Software",
  role: "Software Engineer II / Junior Full-Stack AI Engineer",
  location: "Bay Area",
  status: "Interviewing",
  ...
  link: "",
  priority: "High",
  notes: "Annie from Guidewire left a voicemail on Aug 14 at 4:24 PM about a Software Engineer II role on a product-development team after Arun Prasad forwarded the resume. Original referral title was Junior Full-Stack AI Engineer; confirm whether this is the same requisition. Team guidance emphasizes genuine company interest, attitude, aptitude, and technical strength.",
  nextAction: "Return Annie’s call at (650) 436-4113; confirm requisition title, team, JD, process, and compensation range",
  currentRound: "Inbound recruiter screen / callback",
  completedRounds: 0,
